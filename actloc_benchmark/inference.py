...
try:
    from utils.read_write_model import read_model, write_colmap_pose_file
...
def main():
    ...
    try:
        ...
        if best_angles:
            ...
            logging.info(f"saved best viewing angles to {args.output_angles} and COLMAP style estimate to {colmap_estimate_fn}")
